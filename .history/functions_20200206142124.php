...
function this_scripts_styles() {
	...
	wp_enqueue_style('style', get_stylesheet_uri(), array('reset', 'dashicons', 'gFonts'), '1.0.0');
	...
	wp_enqueue_script('scripts', get_template_directory_uri() . '/js/scripts.js', array('howler'), '1.0.0', true);
}
